...
namespace LetraU3Dv04
{
    public class Game : GameWindow
    {
        ...
        private Vector3 CentroGeometricoU = new Vector3(0.0f, 0.0f, 0.0f);
        ...
        {
            float axisLength = 1.5f; // Longitud de los ejes en ambas direcciones
